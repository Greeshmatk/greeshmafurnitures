    ...
    <!-- Navigation -->
			...
			<div class="container-fluid">
                ...
                <div class="collapse navbar-collapse js-navbar-collapse">
                	<ul class="nav navbar-nav navbar-left">
							...
							Bassett Furniture</a>
						<li class="dropdown">
							<a data-toggle="" class="dropdown-toggle" href="products"><b>Catalogue</b><b class="caret"></b></a>
								
                		</li>
                		<sec:authorize access="hasRole('ADMIN')">
                		
                		<li><a href="<c:url value="/productAdmin"/>" >Admin Page</a></li><li><a href="<c:url value='/logout' />">Sign Out</a></li></sec:authorize>	
                        
                        <sec:authorize access="hasRole('USER')">
                		
                		<li><a href="<c:url value="/cart"/>" >Cart</a></li><li><a href="<c:url value='/logout' />">Sign Out</a></li></sec:authorize>	
		...
		<nav id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<li>
					<a href="<c:url value="/" />" title="Go to Top">Home</a>
				</li>
				<li>
					<a href="about" title="Go to About Us section">About</a>
				</li>
				<li>
					<a href="contact" title="Navigate to Jonathan Adcox IT Resume">Contact Us</a>
				</li>
				...
				<li>
					<a href="login" title="Our Blog">Login</a>
				</li>
			</ul>
		</nav>
